...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const users = yield UserModel_1.default.findByIdAndUpdate(getUser === null || getUser === void 0 ? void 0 : getUser._id, { fullName, businessName, businessContact, memberImage }, { new: true });
        return res.status(200).json({
